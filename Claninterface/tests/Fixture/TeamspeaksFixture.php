 ...
 * TeamspeaksFixture
 */
class TeamspeaksFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'reason' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'player_id' => 1,
                'start' => '2021-01-04 17:24:18',
                'end' => '2021-01-04 17:24:18',
                'reason' => 1,
                'modified' => '2021-01-04 17:24:18',
                'created' => '2021-01-04 17:24:18',
            ],
        ];
        parent::init();
    }
